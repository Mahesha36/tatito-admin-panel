...
function _evtForm(e) {
    ...
    return '<div class="modal-header"><h3 class="modal-title">'+(e.id?'Edit':'Add')+' Event</h3><button class="modal-close" onclick="Helpers.closeModal()">&times;</button></div>' +
        ...
        '<div class="form-group"><label>Event Image</label><div class="upload-zone"><i class="bi bi-cloud-arrow-up"></i><p>Upload event image</p><input type="file" id="evtImage" accept="image/*" hidden></div></div>' +
