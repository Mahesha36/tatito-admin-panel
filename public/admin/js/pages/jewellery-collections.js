...
function _jcForm(c) {
    ...
    return '<div class="modal-header"><h3 class="modal-title">'+(c.id?'Edit':'Add')+' Collection</h3><button class="modal-close" onclick="Helpers.closeModal()">&times;</button></div>' +
        ...
        '<div class="form-group"><label>Image</label><div class="upload-zone"><i class="bi bi-cloud-arrow-up"></i><p>Upload image</p><input type="file" id="jcImage" accept="image/*" hidden></div></div>' +
