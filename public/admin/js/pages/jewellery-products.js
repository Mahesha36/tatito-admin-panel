...
function _jpForm(p) {
    ...
    return '<div class="modal-header"><h3 class="modal-title">'+(p.id?'Edit':'Add')+' Jewellery Product</h3><button class="modal-close" onclick="Helpers.closeModal()">&times;</button></div>' +
        ...
        '<div class="form-group"><label>Image</label><div class="upload-zone"><i class="bi bi-cloud-arrow-up"></i><p>Upload product image</p><input type="file" id="jpImage" accept="image/*" hidden></div></div>' +
